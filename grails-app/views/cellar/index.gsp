...
<body>
<a href="#list-cellar" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
        ...
        <g:each in="${cellarInstanceList}" status="i" var="cellarInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${cellarInstance.id}">${fieldValue(bean: cellarInstance, field: "rate")}</g:link></td>
