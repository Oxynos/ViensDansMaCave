		...
		<div id="list-member" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="dateNaissance" title="${message(code: 'member.dateNaissance.label', default: 'Date Naissance')}" />
				...
				<g:each in="${memberInstanceList}" status="i" var="memberInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${memberInstance.dateNaissance}" /></td>
