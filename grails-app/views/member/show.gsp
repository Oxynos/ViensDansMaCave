    ...
    <ol class="property-list member">
        ...
        <g:if test="${memberInstance?.age}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="age-label"><g:fieldValue bean="${memberInstance}"
                                                                                       field="age"/></span>
        ...
        <g:if test="${memberInstance?.city}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="city-label"><g:fieldValue bean="${memberInstance}"
                                                                                        field="city"/></span>
